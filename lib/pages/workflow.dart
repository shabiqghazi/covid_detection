                    ...
                    children: [
                      Expanded(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(15),
                          child: Text(
                            'Tab Bantuan untuk melihat daftar rumah sakit terdekat!',
                            style: GoogleFonts.signika(
                              textStyle: const TextStyle(
                                color: Color(0xff01b399),
                                fontSize: 15,
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(15),
                          child: Text(
                            'Tab Obrolan untuk melihat daftar obrolan serta meminta bantuan!',
                            style: GoogleFonts.signika(
                              textStyle: const TextStyle(
                                color: Color(0xff01b399),
                                fontSize: 15,
